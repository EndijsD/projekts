                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell>
                        <Typography variant="h6">{data.razotajs}</Typography>
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>
                      ...
                      <TableCell>
                        <Typography variant="h6">{data.modelis}</Typography>
                      </TableCell>
                    </TableRow>
                    <S.GradientTextTableRow pieejamiba={data.pieejamiba}>
                      ...
                      <TableCell>
                        <Typography variant="h6">{data.pieejamiba}</Typography>
                      </TableCell>
              ...
              >
                {data.pieejamiba != 1 && (
                  <S.StyledCountBox>
                    ...
                    <S.StyledTextField
                      label="Skaits"
                      value={count >= 1 ? count : setCount(1)}
                      onChange={(e) =>
                    ...
                    <Button
                      onClick={() =>
                        count < data.pieejamiba && setCount((prev) => prev + 1)
                      }
                    >
                      <Add />
                    </Button>
